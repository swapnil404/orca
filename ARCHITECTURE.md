...
- **PITR placement:** clone restores are limited to the source host because local repositories are host directories bind-mounted into managed containers. Cross-host clones require a future remote/shared repository contract.
